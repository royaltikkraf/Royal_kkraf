<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="u_PaymentOthers.aspx.vb" Inherits="Royal_kkraf.u_PaymentOthers" %>
        ...
        <table style="width: 100%;">
            ...
            <tr>
                ...
                <td style="vertical-align: top; text-align: left">
                    ...
                    <ajaxToolkit:CalendarExtender ID="txtPaymentDate_CalendarExtender" runat="server" BehaviorID="txtPaymentDate_CalendarExtender" TargetControlID="txtPaymentDate" Format="dd/MM/yyyy" />
            ...
            <tr>
                ...
                <td style="vertical-align: top; text-align: left">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtAuthor" ErrorMessage="Author" ForeColor="Red">*</asp:RequiredFieldValidator>
            ...
            <tr>
                ...
                <td style="vertical-align: top; text-align: left">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtPayto" ErrorMessage="Pay To" ForeColor="Red">*</asp:RequiredFieldValidator>
                    <button id="Button1" runat="server" onclick="openPayTo()">
                        Pay To
                    </button>
                </td>
            </tr>
            <tr>
                ...
                <tr>
                    <td style="text-align: left; vertical-align: top">Invoice No*</td>
                    <td style="text-align: center; vertical-align: top">:</td>
                    <td style="vertical-align: top; text-align: left">
                        <asp:TextBox ID="txtInvoiceNo" runat="server" Width="400px"></asp:TextBox>
                    </td>
                    <tr>
                        <td style="text-align: left; vertical-align: top">Loan No*</td>
                        <td style="text-align: center; vertical-align: top">:</td>
                        <td style="vertical-align: top; text-align: left">
                            <asp:TextBox ID="txtLoanNo" runat="server" Width="400px"></asp:TextBox>
                        </td>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td style="vertical-align: top; text-align: left">
                                ...
                                <asp:SqlDataSource ID="PaymentType" runat="server" ConnectionString="<%$ ConnectionStrings:RoyaltiesConn %>" SelectCommand="SELECT Name, [Desc] FROM ConfPaymentType WHERE Class =@Class ORDER BY [Desc]">
                                    <SelectParameters>
                                        <asp:Parameter DefaultValue="2" Name="Class" />
                                    </SelectParameters>
                                </asp:SqlDataSource>
                            </td>
                        </tr>
                            ...
                            <td colspan="3" style="text-align: left; vertical-align: top">
                                <asp:DataGrid ID="SenaraiPayment" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" ForeColor="Black" GridLines="Horizontal" HeaderStyle-BackColor="Blue" HeaderStyle-ForeColor="White" HorizontalAlign="Justify" PagerStyle-Visible="True" Style="border-right: black thin solid; border-top: black thin solid; border-left: black thin solid; border-bottom: black thin solid">
                                    <Columns>
                                        ...
                                        <asp:BoundColumn DataField="LoanNo" HeaderText="Loan No" SortExpression="LoanNo"></asp:BoundColumn>
                                    </Columns>
                                    <FooterStyle BackColor="#CCCC99" ForeColor="Black" />
                                    <HeaderStyle BackColor="#333333" Font-Bold="True" ForeColor="White" HorizontalAlign="Justify" VerticalAlign="Middle" />
                                    <PagerStyle BackColor="White" ForeColor="Black" HorizontalAlign="Right" Mode="NumericPages" VerticalAlign="Middle" />
