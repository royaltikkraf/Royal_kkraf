...
Public Class AuthorList
    ...
    Function LoadGridContract(ByVal SortField As String, ByVal SQuery As String) As Boolean
        ...
        If hfType.Value = "Author" Then
            If SQuery = "" Then
                SQuery = "WHERE AuthorType ='Author'"
            Else
                SQuery = "WHERE AuthorType ='Author' AND " + SQuery
            End If
        Else
            If SQuery <> "" Then
                SQuery = "WHERE " + SQuery
        ...
        SQLQuery = "SELECT * From infAuthor " & SQuery & " Order by Name ASC"
    ...
    Private Sub GridView1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles GridView1.SelectedIndexChanged
        hfIC.Value = GridView1.SelectedRow.Cells.Item(3).Text
